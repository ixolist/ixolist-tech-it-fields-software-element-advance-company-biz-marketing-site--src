...
permalink: apps/mint/architectures/token-production
lang: ru
page_id: apps-mint-architectures-token-production
...
diagramUrl: ru/apps/mint/architectures/token-production/diagrams
videoUrl: ru/apps/mint/architectures/token-production/ux-videos
screensUrl: ru/apps/mint/architectures/token-production/ui-screens
backUrl: /ru/apps/mint/architectures/overall
---
{% assign sorted_diagrams = site.data.diagrams.mint.architectures.token-production | sort: name %}
